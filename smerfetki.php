...
if(isset($_POST["add_to_cart"]))
{
	...
	header("location:smerfetki.php?success=1");
}
  ...
  $( ".change" ).on("click", function() {
    ...
    <div class="search-form">
		...
		<div class="">
			...
			<br /><br />
            <h1 class="heading"> Dostępne <span>smerfetki</span> </h1> 
			<?php
			$query = "SELECT * FROM smerfetki ORDER BY id ASC";
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <h3 class="price"><?php echo $row["price"]; ?>PLN</h3>
